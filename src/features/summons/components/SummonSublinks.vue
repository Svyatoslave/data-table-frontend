...
const subLinks = computed((): SubLink[] => [
  {
    ...
    disabled: false,
    to: `/summons/${props.summonId}/application-forms`,
    name: "Заявки",
  },
  {
    key: "summonInfo",
    disabled: false,
    to: `/summons/${props.summonId}/info`,
    name: "Информация",
  },
  {
    key: "summonTemplate",
  ...
  {
    key: "summonSuggestChange",
    disabled: true,
    to: `/summons/${props.summonId}/suggest-change`,
    name: "Предложить изменение",
  },
  {
